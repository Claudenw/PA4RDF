...
public interface SubjectTable {
     ...
     * 
     * @param predicate
     *            the predicate to remove the value from.
     * @param value
     *            the value to remove.
     */
     ...
     * 
     * @param graph
     *            the graph to copy contents from.
     */
    public void reset(Graph graph);

    /**
     * Return true if the predicate and property exist in the table. Either
     * value may be null for wild card.
     * 
     * @param predicate
     *            the predicate to locate
     * @param value
     *            the value to locate
