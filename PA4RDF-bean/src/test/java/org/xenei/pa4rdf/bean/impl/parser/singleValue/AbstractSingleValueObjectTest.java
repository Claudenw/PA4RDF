...
public abstract class AbstractSingleValueObjectTest
		extends AbstractMethodParserTest
{
			...
			throws NoSuchMethodException, SecurityException
	{
		...
		PIMap.put(isBool, mockPredicateInfo(isBool, "bool", ActionType.GETTER,
				Boolean.class, 0));

		setBool = interfaceClass.getMethod("setBool", Boolean.class);
		PIMap.put(setBool, mockPredicateInfo(setBool, "bool", ActionType.SETTER,
				Boolean.class, 0));

		removeBool = interfaceClass.getMethod("removeBool");
		PIMap.put(removeBool, mockPredicateInfo(removeBool, "bool",
				ActionType.REMOVER, Predicate.UNSET.class, 0));
		...
		PIMap.put(setChar, mockPredicateInfo(setChar, "char", ActionType.SETTER,
				Character.class, 0));
		...
		PIMap.put(setDbl, mockPredicateInfo(setDbl, "dbl", ActionType.SETTER,
				Double.class, 0));
		...
		PIMap.put(setEnt, mockPredicateInfo(setEnt, "ent", ActionType.SETTER,
				TestInterface.class, 0));
		...
		PIMap.put(setFlt, mockPredicateInfo(setFlt, "flt", ActionType.SETTER,
				Float.class, 0));
		...
		PIMap.put(setInt, mockPredicateInfo(setInt, "int", ActionType.SETTER,
				Integer.class, 0));
		...
		PIMap.put(setLng, mockPredicateInfo(setLng, "lng", ActionType.SETTER,
				Long.class, 0));
		...
		PIMap.put(setRDF, mockPredicateInfo(setRDF, "rDF", ActionType.SETTER,
				RDFNode.class, 0));
		...
		PIMap.put(setStr, mockPredicateInfo(setStr, "str", ActionType.SETTER,
				String.class, 0));
		...
		PIMap.put(getU, mockPredicateInfo(getU, "u", ActionType.GETTER,
				RDFNode.class, 0));

		setU_S = interfaceClass.getMethod("setU", String.class);
		PIMap.put(setU_S, mockPredicateInfo(setU_S, "u", ActionType.SETTER,
				String.class, 0));

		setU_R = interfaceClass.getMethod("setU", RDFNode.class);
		PIMap.put(setU_R, mockPredicateInfo(setU_R, "u", ActionType.SETTER,
				RDFNode.class, 0));

		removeU = interfaceClass.getMethod("removeU");
		PIMap.put(removeU, mockPredicateInfo(removeU, "u", ActionType.REMOVER,
				Predicate.UNSET.class, 0));

		getU2 = interfaceClass.getMethod("getU2");
		PIMap.put(getU2, mockPredicateInfo(getU2, "u", ActionType.GETTER,
				String.class, 0));
