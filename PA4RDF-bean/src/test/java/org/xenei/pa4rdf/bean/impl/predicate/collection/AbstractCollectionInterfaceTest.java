...
public abstract class AbstractCollectionInterfaceTest
		extends AbstractPredicateTest
{
	...
	public void processOrderTest()
			throws NoSuchMethodException, SecurityException
	{
		final EffectivePredicate base = new EffectivePredicate(
				interfaceClass.getMethod("addX", String.class));
		...
		final EffectivePredicate setX = new EffectivePredicate(mthd)
				.merge(base);
		...
		final EffectivePredicate hasX = new EffectivePredicate(mthd)
				.merge(base);
	...
	{
		builder.setActionType(ActionType.GETTER).setCollectionType(List.class)
				.setInternalType(null).setLiteralType(null);
		updateGetter();
