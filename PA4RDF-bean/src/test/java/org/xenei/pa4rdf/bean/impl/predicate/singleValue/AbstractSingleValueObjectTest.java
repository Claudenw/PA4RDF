		...
		extends AbstractPredicateTest
{
			...
			throws NoSuchMethodException, SecurityException
	{
		...
		EffectivePredicate base = new EffectivePredicate(
				interfaceClass.getMethod("setBool", Boolean.class));
		...
		base = new EffectivePredicate(
				interfaceClass.getMethod("setChar", Character.class));
		...
		// dbl
		base = new EffectivePredicate(
				interfaceClass.getMethod("setDbl", Double.class));
		...
		// ent
		base = new EffectivePredicate(
				interfaceClass.getMethod("setEnt", TestInterface.class));
		...
		// flt
		base = new EffectivePredicate(
				interfaceClass.getMethod("setFlt", Float.class));
		...
		// int
		base = new EffectivePredicate(
				interfaceClass.getMethod("setInt", Integer.class));
		...
		// lng
		base = new EffectivePredicate(
				interfaceClass.getMethod("setLng", Long.class));
		...
		// RDF
		base = new EffectivePredicate(
				interfaceClass.getMethod("setRDF", RDFNode.class));
		...
		// str
		base = new EffectivePredicate(
				interfaceClass.getMethod("setStr", String.class));
	...
	{
		builder.setActionType(ActionType.GETTER).setName("bool")
				.setInternalType(Literal.class)
	...
	{
		builder.setActionType(ActionType.SETTER).setName("bool")
				.setInternalType(Literal.class)
				.setLiteralType(XSDDatatype.XSDboolean).setType(Boolean.class);
	...
	{
		builder.setActionType(ActionType.REMOVER).setName("bool")
				.setType(Predicate.UNSET.class).setInternalType(RDFNode.class);
	...
	{
		builder.setActionType(ActionType.GETTER).setName("char")
				.setInternalType(Literal.class)
				.setLiteralType(CharacterDatatype.INSTANCE)
	...
	{
		builder.setActionType(ActionType.SETTER).setName("char")
				.setInternalType(Literal.class)
				.setLiteralType(CharacterDatatype.INSTANCE)
				.setType(Character.class);
		assertSame(builder,
	...
	{
		builder.setActionType(ActionType.REMOVER).setName("char")
				.setType(Predicate.UNSET.class).setInternalType(RDFNode.class);
	...
	{
		builder.setActionType(ActionType.GETTER).setName("dbl")
				.setInternalType(Literal.class)
	...
	{
		builder.setActionType(ActionType.SETTER).setName("dbl")
				.setInternalType(Literal.class)
				.setLiteralType(XSDDatatype.XSDdouble).setType(Double.class);
	...
	{
		builder.setActionType(ActionType.REMOVER).setName("dbl")
				.setType(Predicate.UNSET.class).setInternalType(RDFNode.class);
	...
	{
		builder.setActionType(ActionType.GETTER).setName("ent")
	...
	{
		builder.setActionType(ActionType.SETTER).setName("ent")
				.setInternalType(RDFNode.class).setType(TestInterface.class);
		assertSame(builder,
				interfaceClass.getMethod("setEnt", TestInterface.class));
	}
	...
	{
		builder.setActionType(ActionType.REMOVER).setName("ent")
				.setType(Predicate.UNSET.class).setInternalType(RDFNode.class);
	...
	{
		builder.setActionType(ActionType.GETTER).setName("flt")
				.setInternalType(Literal.class)
	...
	{
		builder.setActionType(ActionType.SETTER).setName("flt")
				.setInternalType(Literal.class)
				.setLiteralType(XSDDatatype.XSDfloat).setType(Float.class);
	...
	{
		builder.setActionType(ActionType.REMOVER).setName("flt")
				.setType(Predicate.UNSET.class).setInternalType(RDFNode.class);
	...
	{
		builder.setActionType(ActionType.GETTER).setName("int")
				.setInternalType(Literal.class)
	...
	{
		builder.setActionType(ActionType.SETTER).setName("int")
				.setInternalType(Literal.class)
				.setLiteralType(XSDDatatype.XSDint).setType(Integer.class);
	...
	{
		builder.setActionType(ActionType.REMOVER).setName("int")
				.setType(Predicate.UNSET.class).setInternalType(RDFNode.class);
	...
	{
		builder.setActionType(ActionType.GETTER).setName("lng")
				.setInternalType(Literal.class)
	...
	{
		builder.setActionType(ActionType.SETTER).setName("lng")
				.setInternalType(Literal.class)
				.setLiteralType(LongDatatype.INSTANCE).setType(Long.class);
	...
	{
		builder.setActionType(ActionType.REMOVER).setName("lng")
				.setType(Predicate.UNSET.class).setInternalType(RDFNode.class);
	...
	{
		builder.setActionType(ActionType.GETTER).setName("rDF")
	...
	{
		builder.setActionType(ActionType.SETTER).setName("rDF")
				.setInternalType(RDFNode.class).setType(RDFNode.class);
	...
	{
		builder.setActionType(ActionType.REMOVER).setName("rDF")
				.setType(Predicate.UNSET.class).setInternalType(RDFNode.class);
	...
	{
		builder.setActionType(ActionType.GETTER).setName("str")
				.setInternalType(Literal.class)
	...
	{
		builder.setActionType(ActionType.SETTER).setName("str")
				.setInternalType(Literal.class)
				.setLiteralType(XSDDatatype.XSDstring).setType(String.class);
	...
	{
		builder.setActionType(ActionType.REMOVER).setName("str")
				.setType(Predicate.UNSET.class).setInternalType(RDFNode.class);
