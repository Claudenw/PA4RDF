...
public class CollectionHandlerTest extends AbstractObjectHandlerTest
{
	...
	public void setup()
	{
		underTest = new CollectionHandler(
				new LiteralHandler(XSDDatatype.XSDstring), List.class);
	}
	...
	public void testCreateRDFNode()
	{
		...
		Assert.assertTrue(
				n.asLiteral().getDatatype().equals(XSDDatatype.XSDstring));
	}
	...
	{
		final Object o = underTest
				.parseObject(ResourceFactory.createPlainLiteral("Hello"));
		Assert.assertNotNull(o);
