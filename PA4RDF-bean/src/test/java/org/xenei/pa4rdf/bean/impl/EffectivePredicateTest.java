...
import org.xenei.pa4rdf.bean.test.abst.SingleValueMixedTypeTestClass;
...
public class EffectivePredicateTest
{
	...
	{
		underTest = new EffectivePredicate(
				SimpleInterface.class.getMethod("getX"));
	...
	{
		underTest = new EffectivePredicate(
				SimpleInterface.class.getMethod("setX", String.class));
	...
	{
		underTest = new EffectivePredicate(
				SimpleInterface.class.getMethod("hasX"));
	...
	{
		underTest = new EffectivePredicate(
				SimpleInterface.class.getMethod("removeX"));
	...
	{
		underTest = new EffectivePredicate(
				SingleValueMixedTypeTestClass.class.getMethod("getChar"));
		assertEquals(ActionType.GETTER, underTest.actionType());
	...
	public void multiValueGetTest() throws Exception
	{
		...
		underTest = new EffectivePredicate(
				MultiValueInterface.class.getMethod("getLst"));
		assertEquals(ActionType.GETTER, underTest.actionType());
		...
		final EffectivePredicate setter = new EffectivePredicate(
				MultiValueInterface.class.getMethod("setLst",
						Collection.class));
	...
	{
		underTest = new EffectivePredicate(MultiValueInterface.class
				.getMethod("setLst", Collection.class));
		assertEquals(ActionType.SETTER, underTest.actionType());
		assertEquals(String.class, underTest.type());
		assertEquals(Literal.class, underTest.internalType());
		assertEquals(XSDDatatype.XSDstring, underTest.literalType());
	...
	{
		underTest = new EffectivePredicate(
				MultiValueInterface.class.getMethod("hasLst", String.class));
		assertEquals(ActionType.EXISTENTIAL, underTest.actionType());
		assertEquals(String.class, underTest.type());
		assertEquals(Literal.class, underTest.internalType());
		assertEquals(XSDDatatype.XSDstring, underTest.literalType());
	...
	{
		underTest = new EffectivePredicate(
				MultiValueInterface.class.getMethod("removeLst", String.class));
		assertEquals(ActionType.REMOVER, underTest.actionType());
		assertEquals(String.class, underTest.type());
		assertEquals(Literal.class, underTest.internalType());
		assertEquals(XSDDatatype.XSDstring, underTest.literalType());
