...
{
	EntityFactory factory = new FactoryImpl();
	RDFNode node;
	...
	{
		underTest = new EntityHandler(factory, TwoValueSimpleInterface.class);
		node = ResourceFactory.createResource("http://example.com/tvsi");
		instance = factory.makeInstance(node.asResource(),
				TwoValueSimpleInterface.class);
	}
