		...
		extends AbstractPredicateTest
{
			...
			throws NoSuchMethodException, SecurityException
	{
		...
		final EffectivePredicate getU = new EffectivePredicate(
				interfaceClass.getMethod("getU"));
		builder.setType(RDFNode.class).setCollectionType(List.class)
				.setName("u");
		...
		// U2 Checks
		final EffectivePredicate getU2 = new EffectivePredicate(
				interfaceClass.getMethod("getU2"));
	...
	public void testParseGetter() throws Exception
	{
		builder.setActionType(ActionType.GETTER).setName("u")
				.setCollectionType(List.class).setType(RDFNode.class);
		updateGetter();
	...
	public void testParseSetterS() throws Exception
	{
		builder.setActionType(ActionType.SETTER).setName("u")
				.setCollectionType(Predicate.UNSET.class).setType(URI.class);
		updateSetterS();
	...
	public void testParseRemoverR2() throws Exception
	{
		...
		updateRemoverR2();
		assertSame(builder,
				interfaceClass.getMethod("removeU2", RDFNode.class));
	}
	...
	{
		builder.setActionType(ActionType.REMOVER).setType(URI.class)
				.setCollectionType(Predicate.UNSET.class).setName("u2");
		updateRemoverS2();
