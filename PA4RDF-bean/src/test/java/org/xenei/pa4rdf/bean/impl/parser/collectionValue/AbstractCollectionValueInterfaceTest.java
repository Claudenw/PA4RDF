package org.xenei.pa4rdf.bean.impl.parser.collectionValue;
		...
		extends AbstractMethodParserTest
{
			...
			throws NoSuchMethodException, SecurityException
	{
		...
		PIMap.put(addBool, mockPredicateInfo(addBool, "bool", ActionType.SETTER,
				Boolean.class, 0));
		getBool = underTest.getMethod("getBool");
		PIMap.put(getBool, mockPredicateInfo(getBool, "bool", ActionType.GETTER,
				Set.class, 0));
		hasBool = underTest.getMethod("hasBool", Boolean.class);
		PIMap.put(hasBool, mockPredicateInfo(hasBool, "bool",
				ActionType.EXISTENTIAL, Boolean.class, 0));
		removeBool = underTest.getMethod("removeBool", Boolean.class);
		PIMap.put(removeBool, mockPredicateInfo(removeBool, "bool",
				ActionType.REMOVER, Boolean.class, 0));
		addCount.put("addBool", Integer.valueOf(1));

		addChar = underTest.getMethod("addChar", Character.class);
		PIMap.put(addChar, mockPredicateInfo(addChar, "char", ActionType.SETTER,
				Character.class, 0));
		getChar = underTest.getMethod("getChar");
		PIMap.put(getChar, mockPredicateInfo(getChar, "char", ActionType.GETTER,
				List.class, 0));
		hasChar = underTest.getMethod("hasChar", Character.class);
		PIMap.put(hasChar, mockPredicateInfo(hasChar, "char",
				ActionType.EXISTENTIAL, Boolean.class, 0));
		removeChar = underTest.getMethod("removeChar", Character.class);
		PIMap.put(removeChar, mockPredicateInfo(removeChar, "char",
				ActionType.REMOVER, Character.class, 0));
		addCount.put("addChar", Integer.valueOf(1));

		addDbl = underTest.getMethod("addDbl", Double.class);
		PIMap.put(addDbl, mockPredicateInfo(addDbl, "dbl", ActionType.SETTER,
				Double.class, 0));
		addCount.put("addDbl", Integer.valueOf(1));
		getDbl = underTest.getMethod("getDbl");
		PIMap.put(getDbl, mockPredicateInfo(getDbl, "dbl", ActionType.GETTER,
				Queue.class, 0));
		hasDbl = underTest.getMethod("hasDbl", Double.class);
		PIMap.put(hasDbl, mockPredicateInfo(hasDbl, "dbl",
				ActionType.EXISTENTIAL, Boolean.class, 0));
		removeDbl = underTest.getMethod("removeDbl", Double.class);
		PIMap.put(removeDbl, mockPredicateInfo(removeDbl, "dbl",
				ActionType.REMOVER, Double.class, 0));
		addCount.put("addDbl", Integer.valueOf(1));

		addEnt = underTest.getMethod("addEnt", TestInterface.class);
		PIMap.put(addEnt, mockPredicateInfo(addEnt, "ent", ActionType.SETTER,
				TestInterface.class, 0));
		getEnt = underTest.getMethod("getEnt");
		PIMap.put(getEnt, mockPredicateInfo(getEnt, "ent", ActionType.GETTER,
				Queue.class, 0));
		hasEnt = underTest.getMethod("hasEnt", TestInterface.class);
		PIMap.put(hasEnt, mockPredicateInfo(hasEnt, "ent",
				ActionType.EXISTENTIAL, Boolean.class, 0));
		removeEnt = underTest.getMethod("removeEnt", TestInterface.class);
		PIMap.put(removeEnt, mockPredicateInfo(removeEnt, "ent",
				ActionType.REMOVER, TestInterface.class, 0));
		addCount.put("addEnt", Integer.valueOf(1));

		addFlt = underTest.getMethod("addFlt", Float.class);
		PIMap.put(addFlt, mockPredicateInfo(addFlt, "flt", ActionType.SETTER,
				Float.class, 0));
		getFlt = underTest.getMethod("getFlt");
		PIMap.put(getFlt, mockPredicateInfo(getFlt, "flt", ActionType.GETTER,
				Set.class, 0));
		hasFlt = underTest.getMethod("hasFlt", Float.class);
		PIMap.put(hasFlt, mockPredicateInfo(hasFlt, "flt",
				ActionType.EXISTENTIAL, Boolean.class, 0));
		removeFlt = underTest.getMethod("removeFlt", Float.class);
		PIMap.put(removeFlt, mockPredicateInfo(removeFlt, "flt",
				ActionType.REMOVER, Float.class, 0));
		addCount.put("addFlt", Integer.valueOf(1));

		addInt = underTest.getMethod("addInt", Integer.class);
		PIMap.put(addInt, mockPredicateInfo(addInt, "int", ActionType.SETTER,
				Integer.class, 0));
		getInt = underTest.getMethod("getInt");
		PIMap.put(getInt, mockPredicateInfo(getInt, "int", ActionType.GETTER,
				Queue.class, 0));
		hasInt = underTest.getMethod("hasInt", Integer.class);
		PIMap.put(hasInt, mockPredicateInfo(hasInt, "int",
				ActionType.EXISTENTIAL, Boolean.class, 0));
		removeInt = underTest.getMethod("removeInt", Integer.class);
		PIMap.put(removeInt, mockPredicateInfo(removeInt, "int",
				ActionType.REMOVER, Integer.class, 0));
		addCount.put("addInt", Integer.valueOf(1));

		addLng = underTest.getMethod("addLng", Long.class);
		PIMap.put(addLng, mockPredicateInfo(addLng, "lng", ActionType.SETTER,
				Long.class, 0));
		getLng = underTest.getMethod("getLng");
		PIMap.put(getLng, mockPredicateInfo(getLng, "lng", ActionType.GETTER,
				List.class, 0));
		hasLng = underTest.getMethod("hasLng", Long.class);
		PIMap.put(hasLng, mockPredicateInfo(hasLng, "lng",
				ActionType.EXISTENTIAL, Boolean.class, 0));
		removeLng = underTest.getMethod("removeLng", Long.class);
		PIMap.put(removeLng, mockPredicateInfo(removeLng, "lng",
				ActionType.REMOVER, Long.class, 0));
		addCount.put("addLng", Integer.valueOf(1));

		addRDF = underTest.getMethod("addRDF", RDFNode.class);
		PIMap.put(addRDF, mockPredicateInfo(addRDF, "rDF", ActionType.SETTER,
				RDFNode.class, 0));
		getRDF = underTest.getMethod("getRDF");
		PIMap.put(getRDF, mockPredicateInfo(getRDF, "rDF", ActionType.GETTER,
				List.class, 0));
		hasRDF = underTest.getMethod("hasRDF", RDFNode.class);
		PIMap.put(hasRDF, mockPredicateInfo(hasRDF, "rDF",
				ActionType.EXISTENTIAL, Boolean.class, 0));
		removeRDF = underTest.getMethod("removeRDF", RDFNode.class);
		PIMap.put(removeRDF, mockPredicateInfo(removeRDF, "rDF",
				ActionType.REMOVER, RDFNode.class, 0));
		addCount.put("addRDF", Integer.valueOf(1));

		addStr = underTest.getMethod("addStr", String.class);
		PIMap.put(addStr, mockPredicateInfo(addStr, "str", ActionType.SETTER,
				String.class, 0));
		getStr = underTest.getMethod("getStr");
		PIMap.put(getStr, mockPredicateInfo(getStr, "str", ActionType.GETTER,
				Set.class, 0));
		hasStr = underTest.getMethod("hasStr", String.class);
		PIMap.put(hasStr, mockPredicateInfo(hasStr, "str",
				ActionType.EXISTENTIAL, Boolean.class, 0));
		removeStr = underTest.getMethod("removeStr", String.class);
		PIMap.put(removeStr, mockPredicateInfo(removeStr, "str",
				ActionType.REMOVER, String.class, 0));
		addCount.put("addStr", Integer.valueOf(1));

		addU_R = underTest.getMethod("addU", RDFNode.class);
		PIMap.put(addU_R, mockPredicateInfo(addU_R, "u", ActionType.SETTER,
				RDFNode.class, 0));
		addU_S = underTest.getMethod("addU", String.class);
		PIMap.put(addU_S, mockPredicateInfo(addU_S, "u", ActionType.SETTER,
				String.class, 0));
		getU = underTest.getMethod("getU");
		PIMap.put(getU,
				mockPredicateInfo(getU, "u", ActionType.GETTER, Set.class, 0));
		hasU_R = underTest.getMethod("hasU", RDFNode.class);
		PIMap.put(hasU_R, mockPredicateInfo(hasU_R, "u", ActionType.EXISTENTIAL,
				Boolean.class, 0));
		hasU_S = underTest.getMethod("hasU", String.class);
		PIMap.put(hasU_S, mockPredicateInfo(hasU_S, "u", ActionType.EXISTENTIAL,
				Boolean.class, 0));
		removeU_R = underTest.getMethod("removeU", RDFNode.class);
		PIMap.put(removeU_R, mockPredicateInfo(removeU_R, "u",
				ActionType.REMOVER, RDFNode.class, 0));
		removeU_S = underTest.getMethod("removeU", String.class);
		PIMap.put(removeU_S, mockPredicateInfo(removeU_S, "u",
				ActionType.REMOVER, URI.class, 0));
		addCount.put("addU", Integer.valueOf(2));

		addU3_R = underTest.getMethod("addU3", RDFNode.class);
		PIMap.put(addU3_R, mockPredicateInfo(addU3_R, "u3", ActionType.SETTER,
				RDFNode.class, 0));
		addU3_S = underTest.getMethod("addU3", String.class);
		PIMap.put(addU3_S, mockPredicateInfo(addU3_S, "u3", ActionType.SETTER,
				String.class, 0));
		getU3 = underTest.getMethod("getU3");
		PIMap.put(getU3, mockPredicateInfo(getU3, "u3", ActionType.GETTER,
				Queue.class, 0));
		hasU3_R = underTest.getMethod("hasU3", RDFNode.class);
		PIMap.put(hasU3_R, mockPredicateInfo(hasU3_R, "u3",
				ActionType.EXISTENTIAL, Boolean.class, 0));
		hasU3_S = underTest.getMethod("hasU3", String.class);
		PIMap.put(hasU3_S, mockPredicateInfo(hasU3_S, "u3",
				ActionType.EXISTENTIAL, Boolean.class, 0));
		removeU3_R = underTest.getMethod("removeU3", RDFNode.class);
		PIMap.put(removeU3_R, mockPredicateInfo(removeU3_R, "u3",
				ActionType.REMOVER, RDFNode.class, 0));
		removeU3_S = underTest.getMethod("removeU3", String.class);
		PIMap.put(removeU3_S, mockPredicateInfo(removeU3_R, "u3",
				ActionType.REMOVER, URI.class, 0));
		addCount.put("addU3", Integer.valueOf(2));

		getU4 = underTest.getMethod("getU4");
		PIMap.put(getU4, mockPredicateInfo(getU4, "u3", ActionType.GETTER,
				Set.class, 0));
