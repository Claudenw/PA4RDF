...
public interface EntityManager extends EntityFactory, QueryExecutor {
	...
	/**
	 * Reset the entity manager to its initial state. any pending updates are
	 * discarded. internal structures are reset to remote values.
	 */
	public void reset();
	 ...
	 *            the name to create.
	 * 
	 * @return the EntityManager for the specific model r null for default
	 *         model.
	 */
	 ...
	 * 
	 * @param uri
	 *            the URI to create the resource with.
	 ...
	 * 
	 * @param id
	 *            the Anonymous ID to create the resource with.
	 * @return the resource in the managed model.
	 */
