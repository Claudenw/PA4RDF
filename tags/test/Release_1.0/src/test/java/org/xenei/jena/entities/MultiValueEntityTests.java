...
public class MultiValueEntityTests {
	...
	//BOOLEAN, CHAR, DOUBLE, FLOAT, LONG, INTEGER, STRING, RDFNODE, ENTITY, URI, VOID
	...
	@Test
	public void testRdf() {
		RDFNode cc = ResourceFactory.createResource("cc");
		
		RDFNode dd = ResourceFactory.createResource("dd");;
	...
	public void testEntity() throws MissingAnnotation {
		...
		TestClass dd = manager.read(r, TestClass.class );
	...
	public void testURI() {
		...
		Resource cc = ResourceFactory.createResource("cc");
		Resource dd  = ResourceFactory.createResource("dd");
