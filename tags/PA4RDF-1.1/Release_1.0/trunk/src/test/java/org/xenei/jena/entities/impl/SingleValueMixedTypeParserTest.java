...
public class SingleValueMixedTypeParserTest
{
	...
	public void testB() throws Exception
	{
		...
		ObjectHandler handler = new LiteralHandler( TypeMapper.getInstance().getTypeByClass(Boolean.class) );	
		ObjectHandler phandler = new LiteralHandler( TypeMapper.getInstance().getTypeByClass(c) );
	
		
		Assert.assertEquals("isB", pi.getMethodName());
		Assert.assertEquals(phandler, pi.getObjectHandler());
		Assert.assertEquals(c, pi.getValueClass());
		Assert.assertEquals(namespaceStr + "b", pi.getUriString());
		Assert.assertEquals(namespaceStr, pi.getNamespace());
			...
			IllegalAccessException, NoSuchFieldException
	{
		...
		Assert.assertEquals(phandler, pi.getObjectHandler());
		Assert.assertEquals(c, pi.getValueClass());
		Assert.assertEquals(namespaceStr + "c", pi.getUriString());
		Assert.assertEquals(namespaceStr, pi.getNamespace());
			...
			IllegalAccessException, NoSuchFieldException
	{
		...
		Assert.assertEquals(phandler, pi.getObjectHandler());
		Assert.assertEquals(c, pi.getValueClass());
		Assert.assertEquals(namespaceStr + "d", pi.getUriString());
		Assert.assertEquals(namespaceStr, pi.getNamespace());
			...
			IllegalAccessException, NoSuchFieldException
	{
		...
		Assert.assertEquals(phandler, pi.getObjectHandler());
		Assert.assertEquals(c, pi.getValueClass());
		Assert.assertEquals(namespaceStr + "f", pi.getUriString());
		Assert.assertEquals(namespaceStr, pi.getNamespace());
			...
			IllegalAccessException, NoSuchFieldException
	{
		...
		Assert.assertEquals(phandler, pi.getObjectHandler());
		Assert.assertEquals(c, pi.getValueClass());
		Assert.assertEquals(namespaceStr + "l", pi.getUriString());
		Assert.assertEquals(namespaceStr, pi.getNamespace());
			...
			IllegalAccessException, NoSuchFieldException
	{
		...
		Assert.assertEquals(phandler, pi.getObjectHandler());
		Assert.assertEquals(c, pi.getValueClass());
		Assert.assertEquals(namespaceStr + "i", pi.getUriString());
		Assert.assertEquals(namespaceStr, pi.getNamespace());
			...
			IllegalAccessException, NoSuchFieldException
	{
		...
		ObjectHandler handler = new UriHandler();
