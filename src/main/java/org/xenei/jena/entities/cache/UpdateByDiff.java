...
public class UpdateByDiff {
    ...
    private final Map<Node, Graph> snapshots;
    private final Map<Node, SubjectTable> tables;
    ...
    public synchronized void rollback() {
        for (final Node n : snapshots.keySet()) {
    ...
    private UpdateRequest generateUpdate(String graphName) {
        ...
        origDS.addNamedModel( graphName,
                ModelFactory.createModelForGraph( new MultiUnion( snapshots.values().iterator() ) ) );
