...
public class SimpleURISubjectImplTest extends AbstractPredicateTest {
    public SimpleURISubjectImplTest() {
        ...
        builder.setNamespace( "http://example.com/" ).setName( "u" ).setImpl( true );

    }

    @Test
    public final void testParseGetter() throws Exception {
        builder.setActionType( ActionType.GETTER ).setInternalType( RDFNode.class ).setType( RDFNode.class );
