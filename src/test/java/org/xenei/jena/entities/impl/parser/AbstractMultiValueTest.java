...
public abstract class AbstractMultiValueTest extends BaseAbstractParserTest {
    ...
    public void testBoolean() throws Exception {
        ...
        Assert.assertEquals( AbstractMultiValueTest.NS + "bool", pi.getUriString() );
    ...
    public void testChar() throws Exception {
        ...
        Assert.assertEquals( AbstractMultiValueTest.NS + "char", pi.getUriString() );
        Assert.assertEquals( AbstractMultiValueTest.NS, pi.getNamespace() );
    ...
    public void testDbl() throws Exception {
        ...
        Assert.assertEquals( handler, pi.getObjectHandler( entityManager ) );
        Assert.assertEquals( ExtendedIterator.class, pi.getValueClass() );
        Assert.assertEquals( AbstractMultiValueTest.NS + "dbl", pi.getUriString() );
        Assert.assertEquals( AbstractMultiValueTest.NS, pi.getNamespace() );
    ...
    public void testEntity() throws Exception {
        ...
        Assert.assertEquals( handler, pi.getObjectHandler( entityManager ) );
        Assert.assertEquals( ExtendedIterator.class, pi.getValueClass() );
        Assert.assertEquals( AbstractMultiValueTest.NS + "ent", pi.getUriString() );
        Assert.assertEquals( AbstractMultiValueTest.NS, pi.getNamespace() );
    ...
    public void testFlt() throws Exception {
        ...
        Assert.assertEquals( handler, pi.getObjectHandler( entityManager ) );
        Assert.assertEquals( ExtendedIterator.class, pi.getValueClass() );
        Assert.assertEquals( AbstractMultiValueTest.NS + "flt", pi.getUriString() );
        Assert.assertEquals( AbstractMultiValueTest.NS, pi.getNamespace() );
    ...
    public void testInt() throws Exception {
        ...
        Assert.assertEquals( handler, pi.getObjectHandler( entityManager ) );
        Assert.assertEquals( ExtendedIterator.class, pi.getValueClass() );
        Assert.assertEquals( AbstractMultiValueTest.NS + "int", pi.getUriString() );
        Assert.assertEquals( AbstractMultiValueTest.NS, pi.getNamespace() );
    ...
    public void testLng() throws Exception {
        ...
        Assert.assertEquals( handler, pi.getObjectHandler( entityManager ) );
        Assert.assertEquals( ExtendedIterator.class, pi.getValueClass() );
        Assert.assertEquals( AbstractMultiValueTest.NS + "lng", pi.getUriString() );
        Assert.assertEquals( AbstractMultiValueTest.NS, pi.getNamespace() );
    ...
    public void testRdf() throws Exception {
        ...
        Assert.assertEquals( handler, pi.getObjectHandler( entityManager ) );
        Assert.assertEquals( ExtendedIterator.class, pi.getValueClass() );
        Assert.assertEquals( AbstractMultiValueTest.NS + "rDF", pi.getUriString() );
        Assert.assertEquals( AbstractMultiValueTest.NS, pi.getNamespace() );
    ...
    public void testStr() throws Exception {
        ...
        Assert.assertEquals( handler, pi.getObjectHandler( entityManager ) );
        Assert.assertEquals( ExtendedIterator.class, pi.getValueClass() );
        Assert.assertEquals( AbstractMultiValueTest.NS + "str", pi.getUriString() );
        Assert.assertEquals( AbstractMultiValueTest.NS, pi.getNamespace() );
