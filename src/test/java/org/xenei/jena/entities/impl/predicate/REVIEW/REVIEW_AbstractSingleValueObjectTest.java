package org.xenei.jena.entities.impl.predicate.REVIEW;
...
public abstract class REVIEW_AbstractSingleValueObjectTest extends REVIEW_BaseAbstractParserTest {

    private static String NS = "http://localhost/test#";

    protected REVIEW_AbstractSingleValueObjectTest(final Class<?> classUnderTest) {
    ...
    public void testBoolean() throws Exception {
        ...
        Assert.assertEquals( REVIEW_AbstractSingleValueObjectTest.NS + "bool", pi.getUriString() );
        Assert.assertEquals( REVIEW_AbstractSingleValueObjectTest.NS, pi.getNamespace() );
        ...
        Assert.assertEquals( VoidHandler.INSTANCE, pi.getObjectHandler( entityManager ) );
    ...
    public void testChar() throws Exception {
        ...
        Assert.assertEquals( REVIEW_AbstractSingleValueObjectTest.NS + "char", pi.getUriString() );
        Assert.assertEquals( REVIEW_AbstractSingleValueObjectTest.NS, pi.getNamespace() );
    ...
    public void testDbl() throws Exception {
        ...
        Assert.assertEquals( REVIEW_AbstractSingleValueObjectTest.NS + "dbl", pi.getUriString() );
        Assert.assertEquals( REVIEW_AbstractSingleValueObjectTest.NS, pi.getNamespace() );
    ...
    public void testEntity() throws Exception {
        ...
        final ObjectHandler handler = new EntityHandler( EntityManagerFactory.create(), TestInterface.class );

        Assert.assertEquals( "getEnt", pi.getMethodName() );
        Assert.assertEquals( handler, pi.getObjectHandler( entityManager ) );
        Assert.assertEquals( TestInterface.class, pi.getValueClass() );
        Assert.assertEquals( REVIEW_AbstractSingleValueObjectTest.NS + "ent", pi.getUriString() );
        Assert.assertEquals( REVIEW_AbstractSingleValueObjectTest.NS, pi.getNamespace() );
    ...
    public void testFlt() throws Exception {
        ...
        Assert.assertEquals( REVIEW_AbstractSingleValueObjectTest.NS + "flt", pi.getUriString() );
        Assert.assertEquals( REVIEW_AbstractSingleValueObjectTest.NS, pi.getNamespace() );
    ...
    public void testInt() throws Exception {
        ...
        Assert.assertEquals( REVIEW_AbstractSingleValueObjectTest.NS + "int", pi.getUriString() );
        Assert.assertEquals( REVIEW_AbstractSingleValueObjectTest.NS, pi.getNamespace() );
    ...
    public void testLng() throws Exception {
        ...
        Assert.assertEquals( REVIEW_AbstractSingleValueObjectTest.NS + "lng", pi.getUriString() );
        Assert.assertEquals( REVIEW_AbstractSingleValueObjectTest.NS, pi.getNamespace() );
    ...
    public void testRdf() throws Exception {
        ...
        Assert.assertEquals( REVIEW_AbstractSingleValueObjectTest.NS + "rDF", pi.getUriString() );
        Assert.assertEquals( REVIEW_AbstractSingleValueObjectTest.NS, pi.getNamespace() );
    ...
    public void testStr() throws Exception {
        ...
        Assert.assertEquals( REVIEW_AbstractSingleValueObjectTest.NS + "str", pi.getUriString() );
        Assert.assertEquals( REVIEW_AbstractSingleValueObjectTest.NS, pi.getNamespace() );
    ...
    public void testURI() throws Exception {
        ...
        Assert.assertEquals( RDFNode.class, pi.getValueClass() );
        Assert.assertEquals( REVIEW_AbstractSingleValueObjectTest.NS + "u", pi.getUriString() );
        Assert.assertEquals( REVIEW_AbstractSingleValueObjectTest.NS, pi.getNamespace() );
