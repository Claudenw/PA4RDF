...
public abstract class REVIEW_AbstractMultiValueTest extends REVIEW_BaseAbstractParserTest {
    private static final String NS = "http://localhost/test#";

    protected REVIEW_AbstractMultiValueTest(final Class<?> classUnderTest) {
    ...
    public void testBoolean() throws Exception {
        ...
        Assert.assertEquals( REVIEW_AbstractMultiValueTest.NS + "bool", pi.getUriString() );
        Assert.assertEquals( REVIEW_AbstractMultiValueTest.NS, pi.getNamespace() );
    ...
    public void testChar() throws Exception {
        ...
        Assert.assertEquals( REVIEW_AbstractMultiValueTest.NS + "char", pi.getUriString() );
        Assert.assertEquals( REVIEW_AbstractMultiValueTest.NS, pi.getNamespace() );
    ...
    public void testDbl() throws Exception {
        ...
        Assert.assertEquals( handler, pi.getObjectHandler( entityManager ) );
        Assert.assertEquals( ExtendedIterator.class, pi.getValueClass() );
        Assert.assertEquals( REVIEW_AbstractMultiValueTest.NS + "dbl", pi.getUriString() );
        Assert.assertEquals( REVIEW_AbstractMultiValueTest.NS, pi.getNamespace() );
    ...
    public void testEntity() throws Exception {
        ...
        Assert.assertEquals( handler, pi.getObjectHandler( entityManager ) );
        Assert.assertEquals( ExtendedIterator.class, pi.getValueClass() );
        Assert.assertEquals( REVIEW_AbstractMultiValueTest.NS + "ent", pi.getUriString() );
        Assert.assertEquals( REVIEW_AbstractMultiValueTest.NS, pi.getNamespace() );
    ...
    public void testFlt() throws Exception {
        ...
        Assert.assertEquals( handler, pi.getObjectHandler( entityManager ) );
        Assert.assertEquals( ExtendedIterator.class, pi.getValueClass() );
        Assert.assertEquals( REVIEW_AbstractMultiValueTest.NS + "flt", pi.getUriString() );
        Assert.assertEquals( REVIEW_AbstractMultiValueTest.NS, pi.getNamespace() );
    ...
    public void testInt() throws Exception {
        ...
        Assert.assertEquals( handler, pi.getObjectHandler( entityManager ) );
        Assert.assertEquals( ExtendedIterator.class, pi.getValueClass() );
        Assert.assertEquals( REVIEW_AbstractMultiValueTest.NS + "int", pi.getUriString() );
        Assert.assertEquals( REVIEW_AbstractMultiValueTest.NS, pi.getNamespace() );
    ...
    public void testLng() throws Exception {
        ...
        Assert.assertEquals( handler, pi.getObjectHandler( entityManager ) );
        Assert.assertEquals( ExtendedIterator.class, pi.getValueClass() );
        Assert.assertEquals( REVIEW_AbstractMultiValueTest.NS + "lng", pi.getUriString() );
        Assert.assertEquals( REVIEW_AbstractMultiValueTest.NS, pi.getNamespace() );
    ...
    public void testRdf() throws Exception {
        ...
        Assert.assertEquals( handler, pi.getObjectHandler( entityManager ) );
        Assert.assertEquals( ExtendedIterator.class, pi.getValueClass() );
        Assert.assertEquals( REVIEW_AbstractMultiValueTest.NS + "rDF", pi.getUriString() );
        Assert.assertEquals( REVIEW_AbstractMultiValueTest.NS, pi.getNamespace() );
    ...
    public void testStr() throws Exception {
        ...
        Assert.assertEquals( handler, pi.getObjectHandler( entityManager ) );
        Assert.assertEquals( ExtendedIterator.class, pi.getValueClass() );
        Assert.assertEquals( REVIEW_AbstractMultiValueTest.NS + "str", pi.getUriString() );
        Assert.assertEquals( REVIEW_AbstractMultiValueTest.NS, pi.getNamespace() );
    ...
    public void testURI() throws Exception {
        ...
        Assert.assertEquals( ExtendedIterator.class, pi.getValueClass() );
        Assert.assertEquals( REVIEW_AbstractMultiValueTest.NS + "u", pi.getUriString() );
        Assert.assertEquals( REVIEW_AbstractMultiValueTest.NS, pi.getNamespace() );
    ...
    public void testURIOrdering() throws Exception {
        ...
        Assert.assertEquals( resHandler, pi.getObjectHandler( entityManager ) );
        Assert.assertEquals( ExtendedIterator.class, pi.getValueClass() );
        Assert.assertEquals( REVIEW_AbstractMultiValueTest.NS + "u3", pi.getUriString() );
        Assert.assertEquals( REVIEW_AbstractMultiValueTest.NS, pi.getNamespace() );
