...
public class MethodParserURICollectionTest
{
	...
	public void setUp() throws Exception
	{
		...
		final Map<String, Integer> addCount = countAdders(SimpleURICollectionInterface.class.getMethods());
	...
	{		
		Method m = SimpleURICollectionInterface.class.getMethod( "addU", String.class );
		PredicateInfo pi = parser.parse( m, new EffectivePredicate( m ));
		assertNotNull( "addU( String ) not parsed",  pi );
		assertEquals( ActionType.SETTER, pi.getActionType());
		assertEquals( "addU", pi.getMethodName());
		...
		/*
		pi = subjectInfo.getPredicateInfo( SimpleURICollectionInterface.class.getMethod( "setU", RDFNode.class ) );
		...
		*/
		pi = subjectInfo.getPredicateInfo( SimpleURICollectionInterface.class.getMethod( "getU" ) );
		...
		pi = subjectInfo.getPredicateInfo( SimpleURICollectionInterface.class.getMethod( "hasU") );
		...
		pi = subjectInfo.getPredicateInfo( SimpleURICollectionInterface.class.getMethod( "removeU"));
	...
	{		
		Method m = SimpleURICollectionInterface.class.getMethod( "getU");
		PredicateInfo pi = parser.parse( m, new EffectivePredicate( m ));
		assertNotNull( "getU not parsed",  pi );
		assertEquals( ActionType.GETTER, pi.getActionType());
		assertEquals( "getU", pi.getMethodName());
	...
	{		
		Method m = SimpleURICollectionInterface.class.getMethod( "hasU");
		PredicateInfo pi = parser.parse( m, new EffectivePredicate( m ));
		assertNotNull( "hasU not parsed",  pi );
		assertEquals( ActionType.EXISTENTIAL, pi.getActionType());
		assertEquals( "hasU", pi.getMethodName());
	...
	{		
		Method m = SimpleURICollectionInterface.class.getMethod( "removeU");
		PredicateInfo pi = parser.parse( m, new EffectivePredicate( m ));
		assertNotNull( "removeU not parsed",  pi );
		assertEquals( ActionType.REMOVER, pi.getActionType());
		assertEquals( "removeU", pi.getMethodName());
	...
	{		
		Method m = SimpleURICollectionInterface.class.getMethod( "addU2", String.class );
		PredicateInfo pi = parser.parse( m, new EffectivePredicate( m ));
		assertNotNull( "addU2( String ) not parsed",  pi );
		assertEquals( ActionType.SETTER, pi.getActionType());
		assertEquals( "addU2", pi.getMethodName());
		assertEquals( "http://example.com/", pi.getNamespace());
		assertEquals( "http://example.com/u", pi.getUriString());
		assertEquals( UriHandler.class, ((PredicateInfoImpl)pi).getObjectHandler().getClass());
		assertEquals( String.class, pi.getValueClass());
		...
		*/
		pi = subjectInfo.getPredicateInfo( SimpleURICollectionInterface.class.getMethod( "getU" ) );
		assertNotNull( "getU2 not parsed",  pi );
		assertEquals( ActionType.GETTER, pi.getActionType());
		assertEquals( "getU2", pi.getMethodName());
		assertEquals( "http://example.com/", pi.getNamespace());
		assertEquals( "http://example.com/u", pi.getUriString());
		assertEquals( ResourceHandler.class, ((PredicateInfoImpl)pi).getObjectHandler().getClass());
		assertEquals( RDFNode.class, pi.getValueClass());
		
		pi = subjectInfo.getPredicateInfo( SimpleURICollectionInterface.class.getMethod( "hasU2") );
		assertNotNull( "hasU2 not parsed",  pi );
		assertEquals( ActionType.EXISTENTIAL, pi.getActionType());
		assertEquals( "hasU2", pi.getMethodName());
		assertEquals( "http://example.com/", pi.getNamespace());
		assertEquals( "http://example.com/u", pi.getUriString());
		assertEquals( boolean.class, pi.getValueClass());
		
		pi = subjectInfo.getPredicateInfo( SimpleURICollectionInterface.class.getMethod( "removeU2"));
		assertNotNull( "removeU2 not parsed",  pi );
		assertEquals( ActionType.REMOVER, pi.getActionType());
		assertEquals( "removeU2", pi.getMethodName());
		assertEquals( "http://example.com/", pi.getNamespace());
		assertEquals( "http://example.com/u", pi.getUriString());
		assertEquals( null, pi.getValueClass());
	}
	...
	{		
		Method m = SimpleURICollectionInterface.class.getMethod( "getU2");
		PredicateInfo pi = parser.parse( m, new EffectivePredicate( m ));
		assertNotNull( "getU2 not parsed",  pi );
		Assert.assertEquals(ResourceHandler.class, ((PredicateInfoImpl)pi).getObjectHandler().getClass());
		assertEquals( ActionType.GETTER, pi.getActionType());
		assertEquals( "getU2", pi.getMethodName());
		assertEquals( "http://example.com/", pi.getNamespace());
		assertEquals( "http://example.com/u2", pi.getUriString());
		assertEquals( ExtendedIterator.class, pi.getValueClass());	
	}

	@Test
	public void testStandardHas2() throws Exception
	{		
		Method m = SimpleURICollectionInterface.class.getMethod( "hasU2", String.class);
		PredicateInfo pi = parser.parse( m, new EffectivePredicate( m ));
		assertNotNull( "hasU2 not parsed",  pi );
		assertEquals( ActionType.EXISTENTIAL, pi.getActionType());
		assertEquals( "hasU2", pi.getMethodName());
	...
	{		
		Method m = SimpleURICollectionInterface.class.getMethod( "removeU2");
		PredicateInfo pi = parser.parse( m, new EffectivePredicate( m ));
		assertNotNull( "removeU2 not parsed",  pi );
		assertEquals( ActionType.REMOVER, pi.getActionType());
		assertEquals( "removeU2", pi.getMethodName());
