...
public class CollectionValueObjectTest {
    ...
    public void charTest() throws Exception {
        ...
        Assertions.assertNotNull(
                subjectInfo.getPredicateInfo( CollectionValueInterface.class.getMethod( "removeChar", Character.class ) ) );
        Assertions.assertNotNull(
                subjectInfo.getPredicateInfo( CollectionValueInterface.class.getMethod( "getChar" ) ) );
        Assertions.assertNotNull(
                subjectInfo.getPredicateInfo( CollectionValueInterface.class.getMethod( "hasChar", Character.class ) ) );
    ...
    public void uSeriesTest() throws Exception {
        ...
        pi = methodParser.parse( method );
        PredicateInfoImplTest.assertValues( pi, ActionType.GETTER, Set.class, "getU", void.class,
                ResourceHandler.class, "ResourceHandler", expectedProperty, RDFNode.class );
