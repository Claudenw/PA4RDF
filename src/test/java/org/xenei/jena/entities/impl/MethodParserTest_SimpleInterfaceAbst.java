...
public class MethodParserTest_SimpleInterfaceAbst {
    ...
    public MethodParserTest_SimpleInterfaceAbst() throws Exception {
        getter = SimpleInterfaceAbst.class.getMethod( "getX" );
        setter = SimpleInterfaceAbst.class.getMethod( "setX", String.class );
        remover = SimpleInterfaceAbst.class.getMethod( "removeX" );
        existential = SimpleInterfaceAbst.class.getMethod( "hasX" );
        subjectInfo = new SubjectInfoImpl( SimpleInterfaceAbst.class );
        addCount.clear();
    ...
    private void assertSetX(PredicateInfo predicateInfo) {
        ...
        Assert.assertFalse( "missing annotations", predicateInfo.getAnnotations().isEmpty() );
