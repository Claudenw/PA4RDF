...
public class SimpleURICollectionSubjectImplTest extends AbstractPredicateTest {
    public SimpleURICollectionSubjectImplTest() {
        ...
        builder.setNamespace( "http://example.com/" ).setImpl( true );
    ...
    public void testAddU2_R() throws Exception {
        builder.setActionType( ActionType.SETTER ).setName( "u2" ).setInternalType( RDFNode.class )
                .setType( RDFNode.class );
    ...
    public void testgetU2() throws Exception {
        builder.setActionType( ActionType.GETTER ).setName( "u2" ).setInternalType( RDFNode.class )
    ...
    public final void testHasU() throws Exception {
        builder.setActionType( ActionType.EXISTENTIAL ).setName( "u" ).setInternalType( RDFNode.class )
                .setType( URI.class );
    ...
    public final void testHasU2() throws Exception {
        builder.setActionType( ActionType.EXISTENTIAL ).setName( "u2" ).setInternalType( RDFNode.class )
                .setType( URI.class );
    ...
    public final void testRemoveU() throws Exception {
        builder.setActionType( ActionType.REMOVER ).setName( "u" ).setInternalType( RDFNode.class )
                .setType( URI.class );
    ...
    public final void testRemoveU2_R() throws Exception {
        builder.setActionType( ActionType.REMOVER ).setName( "u2" ).setInternalType( RDFNode.class )
                .setType( RDFNode.class );
