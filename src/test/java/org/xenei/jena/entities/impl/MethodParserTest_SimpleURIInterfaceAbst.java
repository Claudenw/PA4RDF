...
import org.xenei.jena.entities.testing.abst.SimpleURIInterfaceAbst;

public class MethodParserTest_SimpleURIInterfaceAbst {
    ...
    public MethodParserTest_SimpleURIInterfaceAbst() throws Exception {
        getter = SimpleURIInterfaceAbst.class.getMethod( "getU" );
        setterR = SimpleURIInterfaceAbst.class.getMethod( "setU", RDFNode.class );
        setterS = SimpleURIInterfaceAbst.class.getMethod( "setU", String.class );
        remover = SimpleURIInterfaceAbst.class.getMethod( "removeU" );
        existential = SimpleURIInterfaceAbst.class.getMethod( "hasU" );
        subjectInfo = new SubjectInfoImpl( SimpleURIInterfaceAbst.class );
        addCount.clear();
