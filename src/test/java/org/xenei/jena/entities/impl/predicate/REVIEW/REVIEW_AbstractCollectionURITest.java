...
public abstract class REVIEW_AbstractCollectionURITest extends REVIEW_BaseAbstractParserTest {

    protected REVIEW_AbstractCollectionURITest(final Class<?> classUnderTest) {
    ...
    public void testStandardGetter() throws Exception {
        ...
        Assert.assertEquals( ResourceHandler.class, pi.getObjectHandler( entityManager ).getClass() );
    ...
    public void testStandardHas() throws Exception {
        ...
        Assert.assertEquals( UriHandler.class, pi.getObjectHandler( entityManager ).getClass() );
