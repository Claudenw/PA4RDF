...
public abstract class REVIEW_AbstractSimpleURITest extends REVIEW_BaseAbstractParserTest {
    protected REVIEW_AbstractSimpleURITest(final Class<?> classUnderTest) {
    ...
    public void testStandardSetter() throws Exception {
        ...
        Assert.assertEquals( "http://example.com/", pi.getNamespace() );
        Assert.assertEquals( "http://example.com/u", pi.getUriString() );
        Assert.assertEquals( UriHandler.class, ((PredicateInfoImpl) pi).getObjectHandler( entityManager ).getClass() );
        ...
        Assert.assertEquals( "http://example.com/", pi.getNamespace() );
        Assert.assertEquals( "http://example.com/u", pi.getUriString() );
        Assert.assertEquals( ResourceHandler.class,
                ((PredicateInfoImpl) pi).getObjectHandler( entityManager ).getClass() );
        Assert.assertEquals( RDFNode.class, pi.getValueClass() );
