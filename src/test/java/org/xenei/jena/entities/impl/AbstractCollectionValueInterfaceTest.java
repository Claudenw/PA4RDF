...
public abstract class AbstractCollectionValueInterfaceTest extends AbstractMethodParserTest {
    ...
    protected AbstractCollectionValueInterfaceTest( Class<? extends CollectionValueInterface> underTest) throws NoSuchMethodException, SecurityException
    {
        super( underTest);
        NS="http://localhost/test#";
         ...
         PIMap.put( hasDbl, mockPredicateInfo( hasDbl, "dbl", ActionType.EXISTENTIAL, Double.class, 0, 0 ) );
