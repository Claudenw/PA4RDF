...
public abstract class AbstractCollectionValueTest extends BaseAbstractParserTest {
    ...
    public void testBoolean() throws Exception {
        ...
        Assertions.assertEquals( AbstractCollectionValueTest.NS + "bool", pi.getUriString() );
    ...
    public void testChar() throws Exception {
        ...
        Assertions.assertEquals( AbstractCollectionValueTest.NS + "char", pi.getUriString() );
        Assertions.assertEquals( AbstractCollectionValueTest.NS, pi.getNamespace() );
    ...
    public void testDbl() throws Exception {
        ...
        Assertions.assertEquals( AbstractCollectionValueTest.NS + "dbl", pi.getUriString() );
        Assertions.assertEquals( AbstractCollectionValueTest.NS, pi.getNamespace() );
    ...
    public void testEntity() throws Exception {
        ...
        Assertions.assertEquals( handler, pi.getObjectHandler() );
        Assertions.assertEquals( Queue.class, pi.getValueClass() );
        Assertions.assertEquals( AbstractCollectionValueTest.NS + "ent", pi.getUriString() );
        Assertions.assertEquals( AbstractCollectionValueTest.NS, pi.getNamespace() );
    ...
    public void testFlt() throws Exception {
        ...
        Assertions.assertEquals( AbstractCollectionValueTest.NS + "flt", pi.getUriString() );
        Assertions.assertEquals( AbstractCollectionValueTest.NS, pi.getNamespace() );
    ...
    public void testInt() throws Exception {
        ...
        Assertions.assertEquals( handler, pi.getObjectHandler() );
        Assertions.assertEquals( Queue.class, pi.getValueClass() );
        Assertions.assertEquals( AbstractCollectionValueTest.NS + "int", pi.getUriString() );
        Assertions.assertEquals( AbstractCollectionValueTest.NS, pi.getNamespace() );
    ...
    public void testLng() throws Exception {
        ...
        Assertions.assertEquals( handler, pi.getObjectHandler() );
        Assertions.assertEquals( List.class, pi.getValueClass() );
        Assertions.assertEquals( AbstractCollectionValueTest.NS + "lng", pi.getUriString() );
        Assertions.assertEquals( AbstractCollectionValueTest.NS, pi.getNamespace() );
    ...
    public void testRdf() throws Exception {
        ...
        Assertions.assertEquals( handler, pi.getObjectHandler() );
        Assertions.assertEquals( List.class, pi.getValueClass() );
        Assertions.assertEquals( AbstractCollectionValueTest.NS + "rDF", pi.getUriString() );
        Assertions.assertEquals( AbstractCollectionValueTest.NS, pi.getNamespace() );
    ...
    public void testStr() throws Exception {
        ...
        Assertions.assertEquals( handler, pi.getObjectHandler() );
        Assertions.assertEquals( Set.class, pi.getValueClass() );
        Assertions.assertEquals( AbstractCollectionValueTest.NS + "str", pi.getUriString() );
        Assertions.assertEquals( AbstractCollectionValueTest.NS, pi.getNamespace() );
    ...
    public void testURI() throws Exception {
        ...
        Assertions.assertEquals( Set.class, pi.getValueClass() );
        Assertions.assertEquals( AbstractCollectionValueTest.NS + "u", pi.getUriString() );
        Assertions.assertEquals( AbstractCollectionValueTest.NS, pi.getNamespace() );
    ...
    public void testURIOrdering() throws Exception {
        ...
        Assertions.assertEquals( resHandler, pi.getObjectHandler() );
        Assertions.assertEquals( Queue.class, pi.getValueClass() );
        Assertions.assertEquals( AbstractCollectionValueTest.NS + "u3", pi.getUriString() );
        Assertions.assertEquals( AbstractCollectionValueTest.NS, pi.getNamespace() );
