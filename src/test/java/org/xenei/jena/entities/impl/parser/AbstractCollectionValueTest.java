...
public abstract class AbstractCollectionValueTest extends BaseAbstractParserTest {
    ...
    public void testBoolean() throws Exception {
        ...
        Assert.assertEquals( AbstractCollectionValueTest.NS + "bool", pi.getUriString() );
        Assert.assertEquals( AbstractCollectionValueTest.NS, pi.getNamespace() );
    ...
    public void testChar() throws Exception {
        ...
        Assert.assertEquals( AbstractCollectionValueTest.NS + "char", pi.getUriString() );
        Assert.assertEquals( AbstractCollectionValueTest.NS, pi.getNamespace() );
    ...
    public void testDbl() throws Exception {
        ...
        Assert.assertEquals( AbstractCollectionValueTest.NS + "dbl", pi.getUriString() );
        Assert.assertEquals( AbstractCollectionValueTest.NS, pi.getNamespace() );
    ...
    public void testEntity() throws Exception {
        ...
        Assert.assertEquals( handler, pi.getObjectHandler( entityManager ) );
        Assert.assertEquals( Queue.class, pi.getValueClass() );
        Assert.assertEquals( AbstractCollectionValueTest.NS + "ent", pi.getUriString() );
        Assert.assertEquals( AbstractCollectionValueTest.NS, pi.getNamespace() );
    ...
    public void testFlt() throws Exception {
        ...
        Assert.assertEquals( AbstractCollectionValueTest.NS + "flt", pi.getUriString() );
        Assert.assertEquals( AbstractCollectionValueTest.NS, pi.getNamespace() );
    ...
    public void testInt() throws Exception {
        ...
        Assert.assertEquals( handler, pi.getObjectHandler( entityManager ) );
        Assert.assertEquals( Queue.class, pi.getValueClass() );
        Assert.assertEquals( AbstractCollectionValueTest.NS + "int", pi.getUriString() );
        Assert.assertEquals( AbstractCollectionValueTest.NS, pi.getNamespace() );
    ...
    public void testLng() throws Exception {
        ...
        Assert.assertEquals( handler, pi.getObjectHandler( entityManager ) );
        Assert.assertEquals( List.class, pi.getValueClass() );
        Assert.assertEquals( AbstractCollectionValueTest.NS + "lng", pi.getUriString() );
        Assert.assertEquals( AbstractCollectionValueTest.NS, pi.getNamespace() );
    ...
    public void testRdf() throws Exception {
        ...
        Assert.assertEquals( handler, pi.getObjectHandler( entityManager ) );
        Assert.assertEquals( List.class, pi.getValueClass() );
        Assert.assertEquals( AbstractCollectionValueTest.NS + "rDF", pi.getUriString() );
        Assert.assertEquals( AbstractCollectionValueTest.NS, pi.getNamespace() );
    ...
    public void testStr() throws Exception {
        ...
        Assert.assertEquals( handler, pi.getObjectHandler( entityManager ) );
        Assert.assertEquals( Set.class, pi.getValueClass() );
        Assert.assertEquals( AbstractCollectionValueTest.NS + "str", pi.getUriString() );
        Assert.assertEquals( AbstractCollectionValueTest.NS, pi.getNamespace() );
    ...
    public void testURI() throws Exception {
        ...
        Assert.assertEquals( Set.class, pi.getValueClass() );
        Assert.assertEquals( AbstractCollectionValueTest.NS + "u", pi.getUriString() );
        Assert.assertEquals( AbstractCollectionValueTest.NS, pi.getNamespace() );
    ...
    public void testURIOrdering() throws Exception {
        ...
        Assert.assertEquals( resHandler, pi.getObjectHandler( entityManager ) );
        Assert.assertEquals( Queue.class, pi.getValueClass() );
        Assert.assertEquals( AbstractCollectionValueTest.NS + "u3", pi.getUriString() );
        Assert.assertEquals( AbstractCollectionValueTest.NS, pi.getNamespace() );
