...
public class MethodParserMultiValueEntityTest
{
	...
	public void setup() throws MissingAnnotation
	{
		...
		SubjectInfoImpl subjectInfo = new SubjectInfoImpl(MultiValueObjectTestClass.class);
		final Map<String, Integer> addCount = countAdders(MultiValueObjectTestClass.class.getMethods());
	...
	{
		Method m = MultiValueObjectTestClass.class.getMethod( "addBool", Boolean.class );
		...
		Assert.assertEquals(NS + "bool",
				pi.getUriString());
		Assert.assertEquals(NS,
				pi.getNamespace());


		
		 m = MultiValueObjectTestClass.class.getMethod( "removeBool", Boolean.class );
	...
	public void testChar() throws Exception
	{
		...
		m = MultiValueObjectTestClass.class.getMethod( "addChar", Character.class );
		pi = (PredicateInfoImpl) parser.parse( m, new EffectivePredicate( m ));
		...
		m = MultiValueObjectTestClass.class.getMethod( "removeChar", Character.class );
		pi = (PredicateInfoImpl) parser.parse( m, new EffectivePredicate( m ));
		...
		m = MultiValueObjectTestClass.class.getMethod( "hasChar", Character.class );
		pi = (PredicateInfoImpl) parser.parse( m, new EffectivePredicate( m ));
	...
	public void testDbl() throws Exception
	{
		...
		m = MultiValueObjectTestClass.class.getMethod( "removeDbl", Double.class );
		pi = (PredicateInfoImpl) parser.parse( m, new EffectivePredicate( m ));		
	...
	public void testEntity() throws Exception
	{
		...
		final ObjectHandler handler = new EntityHandler(EntityManagerFactory.getEntityManager(),
				TestClass.class);

		Assert.assertEquals(handler, pi.getObjectHandler());
		Assert.assertEquals(ExtendedIterator.class, pi.getValueClass());
		Assert.assertEquals(NS + "ent",
				pi.getUriString());
		Assert.assertEquals(NS,
				pi.getNamespace());

		 m = MultiValueObjectTestClass.class.getMethod( "addEnt", TestClass.class );
		pi = (PredicateInfoImpl) parser.parse( m, new EffectivePredicate( m ));
		...
		Assert.assertEquals(NS,
		 ...
		 m = MultiValueObjectTestClass.class.getMethod( "removeEnt", TestClass.class );
			pi = (PredicateInfoImpl) parser.parse( m, new EffectivePredicate( m ));
		...
		Assert.assertEquals(NS,
		 ...
		 m = MultiValueObjectTestClass.class.getMethod( "hasEnt", TestClass.class );
			pi = (PredicateInfoImpl) parser.parse( m, new EffectivePredicate( m ));
	...
	public void testInt() throws Exception
	{
		...
		m = MultiValueObjectTestClass.class.getMethod( "removeInt", Integer.class );
		 pi = (PredicateInfoImpl) parser.parse( m, new EffectivePredicate( m ));
	...
	public void testRdf() throws Exception
	{
		...
		m = MultiValueObjectTestClass.class.getMethod( "removeRDF", RDFNode.class );
		pi = (PredicateInfoImpl) parser.parse( m, new EffectivePredicate( m ));
	...
	public void testStr() throws Exception
	{
		...
		m = MultiValueObjectTestClass.class.getMethod( "removeStr", String.class );
		pi = (PredicateInfoImpl) parser.parse( m, new EffectivePredicate( m ));
	...
	public void testURIOrdering() throws Exception
	{
		...
		m = MultiValueObjectTestClass.class.getMethod( "removeU3", RDFNode.class );
		pi = (PredicateInfoImpl) parser.parse( m, new EffectivePredicate( m ));
