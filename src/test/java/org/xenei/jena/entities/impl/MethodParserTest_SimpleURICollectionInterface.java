...
public class MethodParserTest_SimpleURICollectionInterface extends AbstractMethodParserTest {
    ...
    private final Method setterR2;
    private final Method setterS2;
    private final Method removerS2;
    private final Method removerR2;
    private final Method existential2;

    public MethodParserTest_SimpleURICollectionInterface() throws Exception {
