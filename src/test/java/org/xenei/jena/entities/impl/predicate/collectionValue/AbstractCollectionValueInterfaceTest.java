...
public abstract class AbstractCollectionValueInterfaceTest extends AbstractPredicateTest {
    ...
    public void testGetBool() throws Exception {
        builder.setActionType( ActionType.GETTER ).setCollectionType( Set.class ).setName( "bool" );
        updateGetBool();
    ...
    public void testGetChar() throws Exception {
        builder.setActionType( ActionType.GETTER ).setCollectionType( List.class ).setName( "char" );
        updateGetChar();
    ...
    public void testGetDbl() throws Exception {
        builder.setActionType( ActionType.GETTER ).setCollectionType( Queue.class ).setName( "dbl" );
        updateGetDbl();
    ...
    public void testGetEnt() throws Exception {
        builder.setActionType( ActionType.GETTER ).setCollectionType( Queue.class ).setName( "ent" );
        updateGetEnt();
    ...
    public void testGetFlt() throws Exception {
        builder.setActionType( ActionType.GETTER ).setCollectionType( Set.class ).setName( "flt" );
        updateGetFlt();
    ...
    public void testGetInt() throws Exception {
        builder.setActionType( ActionType.GETTER ).setCollectionType( Queue.class ).setName( "int" );
        updateGetInt();
    ...
    public void testGetLng() throws Exception {
        builder.setActionType( ActionType.GETTER ).setCollectionType( List.class ).setName( "lng" );
        updateGetLng();
    ...
    public void testGetRDF() throws Exception {
        builder.setActionType( ActionType.GETTER ).setCollectionType( List.class ).setName( "rDF" );
        updateGetRDF();
    ...
    public void testGetStr() throws Exception {
        builder.setActionType( ActionType.GETTER ).setCollectionType( Set.class ).setName( "str" );
        updateGetStr();
    ...
    public void testGetU() throws Exception {
        builder.setActionType( ActionType.GETTER ).setCollectionType( Set.class ).setInternalType( RDFNode.class )
    ...
    public void testGetU3() throws Exception {
        builder.setActionType( ActionType.GETTER ).setCollectionType( Queue.class ).setInternalType( RDFNode.class )
                .setType( RDFNode.class ).setName( "u3" );
        updateGetU3();
