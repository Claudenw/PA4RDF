...
public class PredicateInfoImplTest {
    ...
    Property expectedProperty(final String name) {
    ...
    public void testGetConstructor() throws Exception {
        ...
        final Action action = new Action( TestInterface.class.getMethod( "getInteger" ) );
    ...
    public void testURIConstructor() throws Exception {
        final EffectivePredicate ep = initializePredicate();
        final String handlerStr = "LiteralHandler{Datatype[http://www.w3.org/2001/XMLSchema#int -> class java.lang.Integer]}";
        // URI class
        ...
        final PredicateInfo pi = new PredicateInfoImpl( ep, action );
        PredicateInfoImplTest.assertValues( pi, ActionType.GETTER, Integer.class, "getInteger", void.class,
                LiteralHandler.class, handlerStr, expectedProperty( "integer" ), void.class );
    }
    ...
    public void testGetCollectionConstructor() throws Exception {
        ...
        final Action action = new Action( TestInterface.class.getMethod( "getSet" ) );

        final PredicateInfo pi = new PredicateInfoImpl( ep, action );
        PredicateInfoImplTest.assertValues( pi, ActionType.GETTER, Set.class, "getSet", void.class,
                LiteralHandler.class, expectedHandler, expectedProperty( "set" ), Integer.class );
    }
    ...
    public void testSetCollectionConstructor() throws Exception {
        ...
        final Action action = new Action( TestInterface.class.getMethod( "setIterator", Iterator.class ) );
        final String handlerStr = "LiteralHandler{Datatype[http://www.w3.org/2001/XMLSchema#int -> class java.lang.Integer]}";
    ...
    public void testResourceSetterConstructor() throws Exception {
        final EffectivePredicate ep = initializePredicate();
        final Action action = new Action( TestInterface.class.getMethod( "setRDF", RDFNode.class ) );
    ...
    public void testResourceGetterConstructor() throws Exception {
        final EffectivePredicate ep = initializePredicate();
        final Action action = new Action( TestInterface.class.getMethod( "getRDF" ) );
    ...
    public void testSubjectAnnotatedValueConstructor() throws Exception {
        final EffectivePredicate ep = initializePredicate();
        final Action action = new Action( TestInterface.class.getMethod( "getZ" ) );
