...
// import org.xenei.jena.entities.testing.iface.TestPropertyRenamingInterface;
//
// public class ResourceRenamingTest {
//
// private Model model;
...
// Assertions.assertEquals( String.class, pi.getArgumentType() );
//
...
// Assertions.assertEquals( namespaceStr, pi.getNamespace() );
// Assertions.assertEquals( namespaceStr + "bar", pi.getUriString() );
// Assertions.assertEquals( String.class, pi.getReturnType() );
//
...
// Assertions.assertEquals( namespaceStr, pi.getNamespace() );
// Assertions.assertEquals( namespaceStr + "bar", pi.getUriString() );
// Assertions.assertEquals( void.class, pi.getArgumentType() );
//
// // BAZ test
//
...
// Assertions.assertEquals( namespaceStr, pi.getNamespace() );
// Assertions.assertEquals( namespaceStr + "baz", pi.getUriString() );
// Assertions.assertEquals( ExtendedIterator.class, pi.getReturnType() );
// Assertions.assertEquals( String.class, pi.getEnclosedType() );
//
...
// Assertions.assertEquals( Boolean.class, pi.getArgumentType() );
//
...
// Assertions.assertEquals( namespaceStr, pi.getNamespace() );
// Assertions.assertEquals( namespaceStr + "flag", pi.getUriString() );
// Assertions.assertEquals( Boolean.class, pi.getReturnType() );
//
...
// final SubjectInfo ci = manager.getSubjectInfo(
/// TestPropertyRenamingInterface.class );
...
// // BAR test
//
// m = TestPropertyRenamingInterface.class.getMethod( "setFoomer2", String.class
/// );
// pi = ci.getPredicateInfo( m );
...
// Assertions.assertEquals( void.class, pi.getArgumentType() );
//
// m = TestPropertyRenamingInterface.class.getMethod( "addFoomer", String.class
/// );
// pi = ci.getPredicateInfo( m );
