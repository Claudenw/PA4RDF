 ...
 * method. The annotation should override the method.
 */
public class ImplementedAnnotationTest {
    ...
    public static class NoAnnotationImplementation implements AnnotatedInterface {
    ...
    public void setup() {
        ...
        final Property v = model.createProperty( "http://example.com/testing#", "value" );
        final Property n = model.createProperty( "http://example.com/testing#", "name" );
